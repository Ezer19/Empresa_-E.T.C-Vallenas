                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-3">
                            <small class="text-muted d-block">
                                <i class="fas fa-calendar me-1"></i>Inicio: {{ $proyecto->fecha_inicio->format('d/m/Y') }}
                            </small>
                            @if($proyecto->fecha_fin)
                            <small class="text-muted d-block">
                                <i class="fas fa-calendar-check me-1"></i>Fin: {{ $proyecto->fecha_fin->format('d/m/Y') }}
                            </small>
                            @endif
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="d-flex justify-content-between mb-1">
                                ...
                                <small class="fw-bold text-primary">{{ $proyecto->avance_porcentaje }}%</small>
                            </div>
                        ...
                        <a href="{{ route('proyectos.show', $proyecto->id) }}" class="btn btn-outline-primary w-100">
