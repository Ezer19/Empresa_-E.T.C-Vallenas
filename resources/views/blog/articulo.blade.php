            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center text-white">
                    ...
                    <div class="d-flex justify-content-center align-items-center gap-4 flex-wrap opacity-75">
                        ...
                        <span><i
                                class="fas fa-calendar me-2"></i>{{ isset($articulo->fecha_publicacion) ? \Carbon\Carbon::parse($articulo->fecha_publicacion)->format('d/m/Y') : date('d/m/Y') }}</span>
                    ...
                    @if (isset($articulo->imagen_principal))
                        <div class="mb-5">
                            <img src="{{ asset('storage/blog/' . $articulo->imagen_principal) }}"
                                alt="{{ $articulo->titulo }}" class="img-fluid rounded shadow-lg w-100"
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="#" class="text-decoration-none text-info"><i
                    ...
                    <div class="mt-5 pt-4 border-top">
                        <div class="row g-3">
                            @if (isset($articulo_anterior))
                                <div class="col-md-6">
                                    <a href="{{ route('blog.show', $articulo_anterior->slug) }}"
                            ...
                            @if (isset($articulo_siguiente))
                                <div class="col-md-6">
                                    <a href="{{ route('blog.show', $articulo_siguiente->slug) }}"
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <p class="mb-0">
                                                        {{ $comentario->texto ?? ($comentario->comentario ?? '') }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-lg-4">
                    <div class="sticky-top" style="top: 20px;">
                        ...
                        @if (isset($articulos_relacionados) && count($articulos_relacionados) > 0)
                            <div class="card border-0 shadow-sm mb-4">
                                <div class="card-body">
                                    <h6 class="fw-bold mb-3"><i class="fas fa-bookmark me-2"></i>Artículos Relacionados
                                    </h6>
                                        ...
                                        <a href="{{ route('blog.show', $relacionado->slug) }}"
                                            ...
                                            @if (isset($relacionado->imagen_miniatura))
                                                <img src="{{ asset('storage/blog/' . $relacionado->imagen_miniatura) }}"
                                                    alt="{{ $relacionado->titulo }}" class="rounded me-3"
                                                    style="width: 60px; height: 60px; object-fit: cover;">
                                            @endif
                                            <div class="flex-grow-1">
                                                <p class="fw-bold text-dark mb-1 small">
                                                    {{ Str::limit($relacionado->titulo, 50) }}</p>
