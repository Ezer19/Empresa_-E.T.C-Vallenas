    ...
    <div class="container">
        <div class="row justify-content-center text-center text-white">
            <div class="col-lg-8">
                ...
                <p class="lead mb-0">
                    Conoce a ETC Vallenas, líderes en alquiler de maquinaria pesada en Cusco
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-6">
                <div class="position-relative">
                    ...
                    <div class="position-absolute bottom-0 start-0 m-4 bg-primary text-white p-3 rounded">
...
<section class="section-padding">
    <div class="container">
        <div class="text-center mb-5">
            ...
            <h2 class="fw-bold mb-3">Lo Que Nos Define</h2>
            <p class="text-muted">Principios que guían cada una de nuestras acciones</p>
        </div>

        <div class="row g-4">
            <div class="col-lg-4 col-md-6">
                <div class="card border-0 shadow-sm h-100 text-center hover-scale">
                ...
                <div class="card border-0 shadow-sm h-100 text-center hover-scale">
                    <div class="card-body p-4">
                        <div class="bg-danger bg-opacity-10 rounded-circle d-inline-flex align-items-center justify-content-center mb-3" 
                             style="width: 80px; height: 80px;">
                            <i class="fas fa-hard-hat text-danger fa-2x"></i>
                        </div>
...
<section class="py-5 bg-light">
    <div class="container">
        <div class="text-center mb-5">
            ...
            <h2 class="fw-bold mb-3">El Corazón de ETC Vallenas</h2>
            <p class="text-muted">Profesionales comprometidos con tu éxito</p>
        </div>

        <div class="row g-4">
            <!-- Miembro 1 -->
            <div class="col-lg-3 col-md-6">
                <div class="card border-0 shadow-sm text-center hover-scale">
                    <div class="card-body p-4">
                        <div class="bg-primary bg-opacity-10 rounded-circle d-inline-flex align-items-center justify-content-center mb-3" 
...
<section class="section-padding">
    <div class="container">
        <div class="text-center mb-5">
            <span class="badge bg-primary mb-3">Ventajas Competitivas</span>
        ...
        <div class="row g-4">
            <div class="col-lg-4 col-md-6">
                <div class="d-flex">
                    <div class="bg-primary bg-opacity-10 rounded p-3 me-3" style="height: fit-content;">
                        <i class="fas fa-truck-monster text-primary fa-2x"></i>
                    </div>
                    <div>
                        <h5 class="fw-bold mb-2">Equipos Modernos</h5>
                        <p class="text-muted mb-0">
                            Flota de maquinaria de última generación, constantemente renovada y con tecnología de punta.
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="d-flex">
                    <div class="bg-success bg-opacity-10 rounded p-3 me-3" style="height: fit-content;">
                        <i class="fas fa-tools text-success fa-2x"></i>
                    </div>
                    <div>
                        <h5 class="fw-bold mb-2">Mantenimiento Preventivo</h5>
                        <p class="text-muted mb-0">
                            Programa riguroso de mantenimiento que garantiza el óptimo funcionamiento de cada equipo.
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="d-flex">
                    <div class="bg-warning bg-opacity-10 rounded p-3 me-3" style="height: fit-content;">
                        <i class="fas fa-user-tie text-warning fa-2x"></i>
                    </div>
                    <div>
                        <h5 class="fw-bold mb-2">Personal Certificado</h5>
                        <p class="text-muted mb-0">
                            Operadores y técnicos altamente capacitados con certificaciones nacionales e internacionales.
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="d-flex">
                    <div class="bg-danger bg-opacity-10 rounded p-3 me-3" style="height: fit-content;">
                        <i class="fas fa-headset text-danger fa-2x"></i>
                    </div>
                    <div>
                        <h5 class="fw-bold mb-2">Soporte 24/7</h5>
                        <p class="text-muted mb-0">
                            Asistencia técnica y atención al cliente disponible las 24 horas del día, todos los días del año.
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="d-flex">
                    <div class="bg-info bg-opacity-10 rounded p-3 me-3" style="height: fit-content;">
                        <i class="fas fa-dollar-sign text-info fa-2x"></i>
                    </div>
                    <div>
                        <h5 class="fw-bold mb-2">Precios Competitivos</h5>
                        <p class="text-muted mb-0">
                            Tarifas justas y flexibles adaptadas a las necesidades de cada proyecto sin comprometer calidad.
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="d-flex">
                    ...
                    <div>
                        <h5 class="fw-bold mb-2">Seguros Completos</h5>
                        <p class="text-muted mb-0">
                            Cobertura total de seguros para equipos y personal, brindando tranquilidad en cada proyecto.
                        </p>
                    </div>
                </div>
            </div>
...
<section class="py-5 bg-primary text-white">
    <div class="container">
        <div class="text-center mb-5">
            <h2 class="fw-bold mb-3">Números que Nos Respaldan</h2>
            <p class="opacity-75 mb-0">Nuestra experiencia en cifras</p>
        </div>

        <div class="row g-4 text-center">
            <div class="col-lg-3 col-md-6">
                <div class="counter-item">
                    <h2 class="display-3 fw-bold mb-2" data-target="450">0</h2>
                    <p class="mb-0 opacity-75">Proyectos Completados</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="counter-item">
                    <h2 class="display-3 fw-bold mb-2" data-target="85">0</h2>
                    <p class="mb-0 opacity-75">Equipos en Flota</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="counter-item">
                    <h2 class="display-3 fw-bold mb-2" data-target="280">0</h2>
                    <p class="mb-0 opacity-75">Clientes Satisfechos</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="counter-item">
                    <h2 class="display-3 fw-bold mb-2" data-target="15">0</h2>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-8 mb-4 mb-lg-0">
                <h3 class="fw-bold mb-3">¿Listo para trabajar con nosotros?</h3>
                <p class="text-muted mb-0">
            ...
            <div class="col-lg-4 text-lg-end">
                <a href="{{ route('contacto.index') }}" class="btn btn-primary btn-lg mb-2 me-2">
                    <i class="fas fa-envelope me-2"></i>Contáctanos
                </a>
                <a href="{{ route('maquinaria.index') }}" class="btn btn-outline-primary btn-lg mb-2">
